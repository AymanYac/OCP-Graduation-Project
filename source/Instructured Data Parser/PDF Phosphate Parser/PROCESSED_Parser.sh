...
do
	...
	if [[ "$out" == *Acid* ]]; then
			...
			then
				...
				#python ./TableDetector.py $year/$quart/MGA$typ/PROD/$page.pdf $year/$quart/MGA$typ/PROD/$page.csv
				...
				python ./TableDetector.py $year/$quart/MGA$typ/EXPORTS/$page.pdf $year/$quart/MGA$typ/EXPORTS/$page.csv
			...
			then
				...
				#python ./TableDetector.py $year/$quart/MAP$typ/PROD/$page.pdf $year/$quart/MAP$typ/PROD/$page.csv
				...
				python ./TableDetector.py $year/$quart/MAP$typ/EXPORTS/$page.pdf $year/$quart/MAP$typ/EXPORTS/$page.csv
			...
			then
				...
				#python ./TableDetector.py $year/$quart/DAP$typ/PROD/$page.pdf $year/$quart/DAP$typ/PROD/$page.csv
				...
				python ./TableDetector.py $year/$quart/DAP$typ/EXPORTS/$page.pdf $year/$quart/DAP$typ/EXPORTS/$page.csv
			...
			then
				...
				#python ./TableDetector.py $year/$quart/TSP$typ/PROD/$page.pdf $year/$quart/TSP$typ/PROD/$page.csv
				...
				python ./TableDetector.py $year/$quart/TSP$typ/EXPORTS/$page.pdf $year/$quart/TSP$typ/EXPORTS/$page.csv
