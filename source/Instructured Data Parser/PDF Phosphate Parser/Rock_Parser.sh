...
#mkdir 2>/dev/null $year/$quart/ROCK/u65$typ
#mkdir 2>/dev/null $year/$quart/ROCK/u65$typ/EXPORTS
#mkdir 2>/dev/null $year/$quart/ROCK/u65$typ/EXPORTS/Dones_PDF
#mkdir 2>/dev/null $year/$quart/ROCK/66-68$typ
#mkdir 2>/dev/null $year/$quart/ROCK/66-68$typ/EXPORTS
#mkdir 2>/dev/null $year/$quart/ROCK/66-68$typ/EXPORTS/Dones_PDF
#mkdir 2>/dev/null $year/$quart/ROCK/69-72$typ
#mkdir 2>/dev/null $year/$quart/ROCK/69-72$typ/EXPORTS
#mkdir 2>/dev/null $year/$quart/ROCK/69-72$typ/EXPORTS/Dones_PDF
#mkdir 2>/dev/null $year/$quart/ROCK/73-77$typ
#mkdir 2>/dev/null $year/$quart/ROCK/73-77$typ/EXPORTS
#mkdir 2>/dev/null $year/$quart/ROCK/73-77$typ/EXPORTS/Dones_PDF
#mkdir 2>/dev/null $year/$quart/ROCK/o78$typ
#mkdir 2>/dev/null $year/$quart/ROCK/o78$typ/EXPORTS
#mkdir 2>/dev/null $year/$quart/ROCK/o78$typ/EXPORTS/Dones_PDF
